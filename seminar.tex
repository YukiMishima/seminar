...
によってDOSがどのように変化するのかを図\ref{fig:codos}   に示した。
...
\subsection{CO吸着における実際の反応性と指標$\text{E}_\text{d-hyb}$との相関}
求めた吸着エネルギーと式\ref{ECO}の値とをプロットしたものが以下の図である。

\begin{figure}[hbtp]
    \begin{center}
     \includegraphics[width=8cm]{figure/plot2.png}
    \end{center}
...
できると言える。また、破線で示されている通り、単一結晶表面と複数結晶の構造とでは化学吸着エネルギー
が変化していることがわかる。これは、各金属において、dバンドセンターが違うためにおこる変化であると
考えられる。
